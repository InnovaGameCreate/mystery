...
void draw_Info(int x,int y,char *level) {
	...
	DrawFormatStringToHandle(x - 110+200, y - 45, GetColor(255, 255, 255), Font01, "%d m", save_getinfo()[nowlevel * 3].point);
	DrawFormatStringToHandle(x - 110 + 200, y - 45 + 70, GetColor(255, 255, 255), Font01, "%d m", save_getinfo()[nowlevel * 3 + 1].point);
	DrawFormatStringToHandle(x - 110 + 200, y - 45 + 70 + 70, GetColor(255, 255, 255), Font01, "%d m", save_getinfo()[nowlevel * 3 + 2].point);
}
void rank_Draw() {
